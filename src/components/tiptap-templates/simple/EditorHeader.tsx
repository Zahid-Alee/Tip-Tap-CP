                  ...
                  <div>
                    ...
                    >
                      <DropdownMenuTrigger asChild>
                        <Button className="flex items-center px-3 py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 font-medium rounded-md transition-colors">
                      ...
                      >
                        {translationHistory.map((translation, index) => (
                          <DropdownMenuItem
                            key={index}
                            className={`flex flex-col items-start p-2 hover:ring-0 hover:outline-0 hover:cursor-pointer hover:bg-gray-100 ${
